...
function Footer() {
  return (
    <div className="w-full h-[105vh] bg-zinc-950 px-20 pb-10 pt-16 flex gap-5 footerf">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[6vw] uppercase font-bold leading-10 md:leading-none -mb-2">
            Eye-
          </h1>
          <h1 className="text-[6vw] uppercase font-bold leading-none -mb-2">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] uppercase font-bold leading-none mb-2">
          Presentations
        </h1>
        <div className="flex items-end justify-between">
        <div className="left-left flex flex-col">
            <h1 className="my-2 font-bold text-xl underline italic">Socials :</h1>
            <p className="text-sm md:text-xl lg:text-xl">Instagram</p>
            <p className="text-sm md:text-xl lg:text-xl">Twitter</p>
            <p className="text-sm md:text-xl lg:text-xl">FaceBook</p>
            <p className="text-sm md:text-xl lg:text-xl">Threads</p>
            <h1 className="my-2 font-bold text-xl underline italic">Socials :</h1>
            <p className="text-sm md:text-xl lg:text-xl">Instagram</p>
            <p className="text-sm md:text-xl lg:text-xl">Twitter</p>
            <p className="text-sm md:text-xl lg:text-xl">FaceBook</p>
        ...
        <div className="left-right hidden md:flex md:flex-col mb-20">
        <h1 className="my-2 font-bold text-xl underline italic">Socials :</h1>
        <p className="text-sm md:text-xl lg:text-xl">Instagram</p>
            <p className="text-sm md:text-xl lg:text-xl">Twitter</p>
            <p className="text-sm md:text-xl lg:text-xl">FaceBook</p>
