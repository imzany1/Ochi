...
const Navbar = () => {
  ...
  return (
    <div className="Navbars z-50">
      <div
        className={`navbar-large fixed w-full px-[10vw] md:px-[3vw] py-[3vh] justify-between items-center flex bg-transparent backdrop-blur-sm transition-transform duration-500 ease-in-out z-50 ${
      ...
      >
        ...
        <div className="links gap-10 text-xl font-light hidden md:flex">
          <a className="hover:backdrop-blur-md backdrop:bg-red-500 transition-all duration-500 link" href="#">Services</a>
          <a className="hover:backdrop-blur-md backdrop:bg-red-500 transition-all duration-500 link" href="#">Our Work</a>
          <a className="hover:backdrop-blur-md backdrop:bg-red-500 transition-all duration-500 link" href="#">About Us</a>
          <a className="hover:backdrop-blur-md backdrop:bg-red-500 transition-all duration-500 link" href="#">Insights</a>
          <a className="lg:ml-[15vw]" href="#">
            Contact Us
          </a>
        </div>
        <div
        ...
        >
          {showTopbar ? (
            <IoCloseOutline size={"1.6rem"} color="white" />
          ) : (
      ...
      <div
        className={`drop-bar fixed z-50 ${
          showTopbar ? "top-0" : "top-[-100%]"
        } duration-700 ease-in-out bg-slate-200 w-full h-screen`}
      >
        <div className="flex justify-between items-center border-b border-black px-[10vw] py-[3vh] pb-5">
        ...
        <div className="links text-black flex font-[Teko] tracking-wider flex-col items-start px-[10vw] gap-2 py-20 underline decoration-2 underline-offset-4 uppercase font-extrabold text-5xl">
          <a href="#">Services</a>
          <a href="#">Our Work</a>
          <a href="#">About Us</a>
          <a href="#">Insights</a>
